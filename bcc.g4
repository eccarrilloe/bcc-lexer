...
var_decl:
	IDENTIFICADOR TK_DOSPUNTOS datatype (
		TK_COMA IDENTIFICADOR TK_DOSPUNTOS datatype
	)*;
fn_decl_list: (
...
stmt:
	...
	| TK_INPUT IDENTIFICADOR TK_PUNTOYCOMA
	...
	| IDENTIFICADOR TK_ASIGNACION lexpr TK_PUNTOYCOMA
	| IDENTIFICADOR TK_SUM_ASIG lexpr TK_PUNTOYCOMA
	| IDENTIFICADOR TK_RES_ASIG lexpr TK_PUNTOYCOMA
	| IDENTIFICADOR TK_MUL_ASIG lexpr TK_PUNTOYCOMA
	| IDENTIFICADOR TK_DIV_ASIG lexpr TK_PUNTOYCOMA
	| IDENTIFICADOR TK_MOD_ASIG lexpr TK_PUNTOYCOMA
	| IDENTIFICADOR TK_INCREMENTO TK_PUNTOYCOMA
	| IDENTIFICADOR TK_DECREMENTO TK_PUNTOYCOMA
	| TK_DECREMENTO IDENTIFICADOR TK_PUNTOYCOMA
	| TK_INCREMENTO IDENTIFICADOR TK_PUNTOYCOMA;
...
factor:
	...
	| TRUE
	| FALSE
	| IDENTIFICADOR (TK_INCREMENTO | TK_DECREMENTO)
	| (TK_INCREMENTO | TK_DECREMENTO) IDENTIFICADOR
	| IDENTIFICADOR
